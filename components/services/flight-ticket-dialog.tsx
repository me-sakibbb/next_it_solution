...
export function FlightTicketDialog({ isOpen, onOpenChange, triggerButton = false, onSuccess }: FlightTicketDialogProps) {
    ...
    const dialogContent = (
        <Dialog open={activeOpen} onOpenChange={handleClose}>
            <DialogContent className="sm:max-w-[700px] p-0 overflow-hidden hide-scrollbar max-h-[90vh] flex flex-col">
                <div className="relative h-48 shrink-0 w-full overflow-hidden bg-gradient-to-r from-blue-600 to-indigo-700">
                ...
                <div className="p-6 overflow-y-auto overflow-x-hidden flex-1">
                    {submitted ? (
                        <div className="flex flex-col items-center justify-center py-10 text-center space-y-4">
                            ...
                            <h3 className="text-2xl font-bold text-gray-900">রিকোয়েস্ট সফল হয়েছে!</h3>
                            <p className="text-gray-500 max-w-md">
                                আপনার ফ্লাইট টিকিটের রিকোয়েস্ট সফলভাবে গ্রহণ করা হয়েছে। আমাদের প্রতিনিধি খুব শীঘ্রই আপনার সাথে যোগাযোগ করে সম্ভাব্য খরচের পরিমাণ জানাবে।
                            </p>
                            <Button className="w-full mt-6" onClick={() => activeOpenChange(false)}>
                                বন্ধ করুন
                            </Button>
                        </div>
                    ) : (
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="pt-4">
                                <Button
                                    type="submit"
                                    className="w-full h-11 text-base font-bold bg-blue-600 hover:bg-blue-700 shadow-md transition-all"
                                    disabled={loading}
                                >
                                    {loading ? 'প্রক্রিয়াধীন...' : 'রিকোয়েস্ট পাঠান'}
                                </Button>
                            </div>
